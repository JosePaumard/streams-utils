...
public class GroupingOnGatingOpenedClosedSpliteratorTest {
    ...
    public void should_group_a_non_empty_stream_with_correct_substreams_content() {
        ...
        assertThat(collect.get(0)).isEqualTo(Arrays.asList("2", "3", "c"));
        assertThat(collect.get(1)).isEqualTo(Arrays.asList("7", "8", "c"));
    }
    ...
    public void should_group_a_non_empty_stream_with_correct_substreams_content_with_opener_and_closer_at_first_and_last_position() {
        ...
        assertThat(collect.get(0)).isEqualTo(Arrays.asList("1", "2", "3", "4", "5", "6", "7", "8", "9", "c"));
    }
}