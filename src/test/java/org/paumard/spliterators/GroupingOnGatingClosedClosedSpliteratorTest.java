...
public class GroupingOnGatingClosedClosedSpliteratorTest {
    ...
    public void should_group_an_empty_stream_into_an_empty_stream() {
        ...
        // When
        Stream<Stream<String>> groupingOnGatingStream = StreamsUtils.group(strings, open, false, close, false);
    ...
    public void should_group_a_non_empty_stream_with_correct_substreams_content() {
        ...
        // When
        Stream<Stream<String>> groupingStream = StreamsUtils.group(strings, open, false, close, false);
    ...
    public void should_group_a_sorted_stream_correctly_and_in_an_unsorted_stream() {
        ...
        // When
        Stream<Stream<String>> groupingStream = StreamsUtils.group(sortedSet.stream(), open, false, close, false);
    ...
    public void should_conform_to_specified_trySplit_behavior() {
        ...
        Stream<Stream<String>> testedStream = StreamsUtils.group(strings, open, false, close, false);
    ...
    public void should_correctly_call_the_onClose_callbacks_of_the_underlying_streams() {
        ...
        // When
        StreamsUtils.group(strings, open, false, close, false).close();
    ...
    public void should_correctly_count_the_elements_of_a_sized_stream() {
        ...
        Stream<Stream<String>> stream = StreamsUtils.group(strings, open, false, close, false);
