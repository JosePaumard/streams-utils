 ...
 * Created by José
 */
public class ShiftingWindowAveragingIntTest {
    ...
    public void should_average_an_empty_stream_into_a_stream_of_an_empty_stream() {
        ...
        // When
        DoubleStream stream = StreamsUtils.shiftingWindowAveragingInt(ints, groupingFactor, Integer::valueOf);
    ...
    public void should_average_a_non_empty_stream_with_correct_substreams_content() {
        ...
        // When
        DoubleStream averagedStream = StreamsUtils.shiftingWindowAveragingInt(strings, groupingFactor, Integer::parseInt);
    ...
    public void should_process_a_sorted_stream_correctly_and_in_an_unsorted_stream() {
        ...
        // When
        DoubleStream stream = StreamsUtils.shiftingWindowAveragingInt(sortedSet.stream(), groupingFactor, Integer::parseInt);
    ...
    public void should_correctly_call_the_onClose_callbacks_of_the_underlying_streams() {
        ...
        // When
        StreamsUtils.shiftingWindowAveragingInt(strings, groupingFactor, Integer::parseInt).close();
    ...
    public void should_correctly_count_the_elements_of_a_sized_stream() {
        ...
        int groupingFactor = 3;
        DoubleStream stream = StreamsUtils.shiftingWindowAveragingInt(strings, groupingFactor, Integer::parseInt);
